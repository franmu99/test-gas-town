...
const footerLinks = {
  ...
  servicios: [
    ...
    { name: "Programa de fidelidad", href: "/fidelidad" },
  ],
  soporte: [
    { name: "Centro de ayuda", href: "/ayuda" },
    { name: "Contacto", href: "/contacto" },
    { name: "Estado del servicio", href: "/estado" },
    { name: "Reclamaciones", href: "/reclamaciones" },
  ],
  legal: [
  ...
  return (
    <footer className="bg-slate-900 text-slate-300" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 border-t border-slate-800 pt-6 sm:flex-row sm:justify-between">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} RentaCar. Todos los derechos
            reservados.
          </p>
          <div className="flex items-center gap-4 text-sm text-slate-500">
            <span>ES &middot; EUR (&euro;)</span>
          </div>
        </div>
      </div>
    </footer>
